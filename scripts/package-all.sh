...
echo "   - iOS:     ios/ (XcodeGen & SwiftUI project ready for TestFlight / App Store)"
echo "   - Windows: windows/ (Tauri / NSIS / MSI buildable via 'npm run build')"
echo "   - Linux:   linux/ (AppImage / DEB buildable via 'npm run build')"
echo "   - Android: android/ (Gradle / APK buildable via './gradlew assembleDebug')"
echo "======================================================="
